    ...
    <!--<header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 id="homeHeading">Ukraine Page</h1>
                <hr>
                <p>Department of Electrical and Computer Engineering, Iowa State University</p>
                <a href="#controlcenter" class="btn btn-primary btn-xl page-scroll">Experiment</a>
            </div>
        </div>
    </header>-->
    ...
    <section id="controlcenter">
        <div class="container">
            <h2>Control Center</h2>
                ...
                <iframe class="embed-responsive-item" src="https://10.1.200.79:8081/vnc/"></iframe>
            </div>
        </div>
    </section>
