    ...
    <!--<header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 id="homeHeading">StoryBoard Page</h1>
                <hr>
                <p>Department of Electrical and Computer Engineering, Iowa State University</p>
                <a href="#storyboards" class="btn btn-primary btn-xl page-scroll">Select Storyboard</a>
            </div>
        </div>
    </header>-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <h2 class="section-heading text-center">Storyboards</h2>
                    <hr class="light">
